...
@NoArgsConstructor
@AllArgsConstructor
//@Builder : Permet de créer un objet sans utiliser un constructeur.=> Utile pour créer un objet sans devoir passer tous les paramètres.
@Builder
public class Property {
   ...
   private PropertyRule rules;
    ...
    // @PrePersist et @PreUpdate sont  utiles pour exécuter auto du code avant actions sur la base de données.
